...
/*property
    ...
    CARRIAGE RETURN, CHARACTER TABULATION, CIRCUMFLEX ACCENT, COLON, COMMA,
    COMMERCIA AT, DATA LINK ESCAPE, DELETE, DEVICE CONTROL FOUR,
    DEVICE CONTROL ONE, DEVICE CONTROL THREE, DEVICE CONTROL TWO, DIGIT EIGHT,
    DIGIT FIVE, DIGIT FOUR, DIGIT NINE, DIGIT ONE, DIGIT SEVEN, DIGIT SIX,
    DIGIT THREE, DIGIT TWO, DIGIT ZERO, DOLLAR SIGN, END OF MEDIUM, END OF TEXT,
    END OF TRANSMISSION, END OF TRANSMISSION BLOCK, ENQUIRY, EQUALS SIGN,
    ESCAPE, EXCLAMATION MARK, FORM FEED, FULL STOP, GRAVE ACCENT,
    GREATER THAN SIGN, HYPHEN MINUS, INFORMATION SEPARATOR FOUR,
    INFORMATION SEPARATOR ONE, INFORMATION SEPARATOR THREE,
    INFORMATION SEPARATOR TWO, LATIN CAPITAL LETTER A, LATIN CAPITAL LETTER B,
    ...
    LATIN SMALL LETTER A, LATIN SMALL LETTER B, LATIN SMALL LETTER C,
    LATIN SMALL LETTER D, LATIN SMALL LETTER E, LATIN SMALL LETTER F,
    LATIN SMALL LETTER G, LATIN SMALL LETTER H, LATIN SMALL LETTER I,
    LATIN SMALL LETTER J, LATIN SMALL LETTER K, LATIN SMALL LETTER L,
    LATIN SMALL LETTER M, LATIN SMALL LETTER N, LATIN SMALL LETTER O,
    LATIN SMALL LETTER P, LATIN SMALL LETTER Q, LATIN SMALL LETTER R,
    LATIN SMALL LETTER S, LATIN SMALL LETTER T, LATIN SMALL LETTER U,
    LATIN SMALL LETTER V, LATIN SMALL LETTER W, LATIN SMALL LETTER X,
    LATIN SMALL LETTER Y, LATIN SMALL LETTER Z, LEFT CURLY BRACKET,
    LEFT PARENTHESIS, LEFT SQUARE BRACKET, LESS THAN SIGN, LINE FEED,
    LINE TABULATION, LOW LINE, NEGATIVE ACKNOWLEDGE, NULL, NUMBER SIGN,
    PERCENT SIGN, PLUS SIGN, QUESTION MARK, QUOTATION MARK, REVERSE SOLIDUS,
    RIGHT CURLY BRACKET, RIGHT PARENTHESIS, RIGHT SQUARE BRACKET, SEMICOLON,
    SHIFT IN, SHIFT OUT, SOLIDUS, SPACE, START OF HEADING, START OF TEXT,
    SUBSTITUTE, SYNCHRONOUS IDLE, TILDE, VERTICAL LINE
*/
unicode["C0 Controls and Basic Latin"] = {
    ...
    "SUBSTITUTE": 0x001A,
    "ESCAPE": 0x001B,
    "INFORMATION SEPARATOR FOUR (FS)": 0x001C,
    "INFORMATION SEPARATOR THREE (GS)": 0x001D,
    "INFORMATION SEPARATOR TWO (RS)": 0x001E,
    "INFORMATION SEPARATOR ONE (US)": 0x001F,
    "SPACE": 0x0020,
