...
*/
/*property
    AMPERSAND, APOSTROPHE, ASTERISK, CIRCUMFLEX ACCENT, COLON, COMMA,
    COMMERCIA AT, DIGIT EIGHT, DIGIT FIVE, DIGIT FOUR, DIGIT NINE, DIGIT ONE,
    DIGIT SEVEN, DIGIT SIX, DIGIT THREE, DIGIT TWO, DIGIT ZERO, DOLLAR SIGN,
    EQUALS SIGN, EXCLAMATION MARK, FULL STOP, GRAVE ACCENT, GREATER THAN SIGN,
    HYPHEN MINUS, LATIN CAPITAL LETTER A, LATIN CAPITAL LETTER B,
    ...
    LEFT PARENTHESIS, LEFT SQUARE BRACKET, LESS THAN SIGN, LOW LINE,
    NUMBER SIGN, PERCENT SIGN, PLUS SIGN, QUESTION MARK, QUOTATION MARK,
    REVERSE SOLIDUS, RIGHT PARENTHESIS, RIGHT SQUARE BRACKET, SEMICOLON,
    SOLIDUS, SPACE
*/
