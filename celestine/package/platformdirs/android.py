...
class Android(PlatformDirsABC):
    ...
    `from here <https://android.stackexchange.com/a/216132>`_.
    Makes use of the
    ...
    def user_cache_dir(self) -> str:
        ...
        e.g. e.g. ``/data/user/<userid>/<packagename>/cache/<AppName>``
        """
        return self._append_app_name_and_version(
    ...
    def user_log_dir(self) -> str:
        ...
        same as `user_cache_dir` if not opinionated else ``log`` in it,
    ...
    def user_runtime_dir(self) -> str:
        ...
        same as `user_cache_dir` if not opinionated else ``tmp`` in it,
...
def _android_folder() -> str | None:
    """:return: base folder for the Android OS or None if cannot be.
