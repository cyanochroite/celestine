...
encoding = {
    ...
    CHARACTER_TABULATION_WITH_JUSTIFICATION: True,
    ...
    SINGLE_GRAPHIC_CHARACTER_INTRODUCER: True,
    ...
    LEFT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK: True,
    NOT_SIGN: True,
    ...
    RIGHT_POINTING_DOUBLE_ANGLE_QUOTATION_MARK: True,
