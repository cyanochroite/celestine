...
def one(ring: R, view: View) -> N:
    ...
    with view.zone("one_head") as line:
        ...
        line.new("one_A", text=language.DEMO_ONE_ACTION,
                 code="cow", say=language.DEMO_ONE_SAY)
...
def two(ring: R, view: View) -> N:
    ...
    with view.zone("two_head") as line:
        ...
        line.new("two_A", text=language.DEMO_TWO_ACTION,
                 code="cow", say=language.DEMO_TWO_SAY)
...
def main(ring: R, view: View) -> N:
    ...
    with view.zone("main_head") as line:
        ...
        line.new("main_A", text=language.DEMO_MAIN_ACTION,
                 code="cow", say=language.DEMO_MAIN_SAY)
