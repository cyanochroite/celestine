...
def main(ring: R, view: View) -> N:
    ...
    with view.zone("main_head") as line:
        ...
        line.new("main_action", text=language.CLEAN_MAIN_CLEAN, code="clean")
    with view.zone("main_body") as line:
        line.new("main_L", text=language.CLEAN_MAIN_VERSION, code="version")
        line.new("main_R", text=language.CLEAN_MAIN_LICENCE, code="licence")
